...
class AdminViewStudentCourse extends Component {
    ...
    fetchAllStudents = () =>{
        fetch('https://attendxyz.herokuapp.com/admin/studentCourses',{
            method : 'get',
            headers : {
        ...
        return (
            <div className="m-2">
                ...
                <div>
                    ...
                    <br/>
                    <br/>
                    <h1 id="vsh1" className="m-1 text-center">{/*this.state.testName*/}Total Students With Courses</h1>
                    <br/>
                    <br/>
                    ...
                    <div>
                        ...
                        { this.state.students.length===0?<h2>No courses Assigned to students Yet</h2>:
...
export default withRouter(AdminViewStudentCourse)
